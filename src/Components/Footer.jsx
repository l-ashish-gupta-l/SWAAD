...
function Footer() {
    return (<>        <div className='w-full bg-[#252423] text-[#CAB3A8] flex justify-center items-center flex-col border-b-[1px] border-[#9E9B9B]'>
        ...
        <div>
            <div className='Links flex justify-between gap-24  font-["para"] bg-[#252423] text-[#CAB3A8] px-5 py-3'>
                <div className='link  text-center w-[15vw]'>
